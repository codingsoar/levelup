...
const defaultShopItems = [
    { id: 'snack-1', name: '과자 교환권', description: '매점에서 과자 1개 교환', price: 5, icon: '🍪', category: 'snack', stock: 99 },
    { id: 'snack-2', name: '음료 교환권', description: '매점에서 음료 1개 교환', price: 8, icon: '🧃', category: 'snack', stock: 99 },
    { id: 'snack-3', name: '아이스크림 교환권', description: '매점에서 아이스크림 1개 교환', price: 10, icon: '🍦', category: 'snack', stock: 99 },
    { id: 'privilege-1', name: '자리 선택권', description: '다음 수업 시간에 자리를 먼저 선택', price: 3, icon: '💺', category: 'school', stock: 99 },
    { id: 'privilege-2', name: '0교시 면제권', description: '0교시 1회 면제', price: 15, icon: '😴', category: 'school', stock: 5 },
    { id: 'privilege-3', name: '숙제 면제권', description: '숙제 1회 면제', price: 20, icon: '📝', category: 'school', stock: 3 },
    { id: 'privilege-4', name: '청소 면제권', description: '청소 1회 면제', price: 12, icon: '🧹', category: 'school', stock: 5 },
    { id: 'sticker-1', name: '칭찬 스티커', description: '생활기록부 칭찬 스티커 1장', price: 7, icon: '⭐', category: 'special', stock: 99 },
    { id: 'sticker-2', name: '골드 스티커', description: '특별 골드 칭찬 스티커', price: 15, icon: '🏅', category: 'special', stock: 10 },
    { id: 'item-1', name: '볼펜 세트', description: '예쁜 볼펜 3색 세트', price: 10, icon: '🖊️', category: 'stationery', stock: 20 },
    { id: 'item-2', name: '노트', description: '귀여운 캐릭터 노트', price: 8, icon: '📓', category: 'stationery', stock: 20 },
    { id: 'item-3', name: '마스킹 테이프', description: '데코용 마스킹 테이프', price: 6, icon: '🎀', category: 'stationery', stock: 15 },
];
